...
import {deleteQuestion, postAnswer, voteQuestion, postQuestionComment} from '../../actions/question'
...
const QuestionsDetails = () => {
    ...
    // const url = 'https://stackoverflow-clone-app.netlify.app';
    ...
    const postComment = (e) => {
        dispatch(postQuestionComment({id, questionComment:commentData}))
    }
                                            ...
                                            <div>
                                                ...
                                                <button type='button' onClick={handleComment}>Comment</button>
                                                {
                                                    comment && (
                                                        <>
                                                            <br/>
                                                            <textarea rows="4" cols="50" onChange={(e) => setCommentData(e.target.value)}></textarea><br/>
                                                            <button onClick={postComment}>Post Comment</button>
                                                            <button onClick={() => showComment(false)}>Cancel</button>
                                                        </>
                                                    )
                                                }
                                            </div>
